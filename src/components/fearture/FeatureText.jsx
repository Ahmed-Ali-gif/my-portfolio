...
const FeatureText = ({heading,para}) => {
  return (
    <div>
      ...
      <p className="py-2 text-sm w-80 py-2">
       {para}
      </p>
      ...
      <div className="flex items-center gap-2 mt-12">
        <Button className="px-2 py-1 rounded-xl border" title="Live Demo" icon={<FaLocationArrow />}/>
        <Button className="px-2 py-1 rounded-xl border" title="GitHub" icon={<FaGithub />}/>
      </div>
    </div>
  );
};
