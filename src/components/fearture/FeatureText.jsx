  ...
  return (
    <div>
      ...
      <div className="flex items-center mt-4 gap-2">
        <Button className="px-2 mx-2 py-1 rounded-xl border" title="HTML" />
        <Button className="px-2 mx-2 py-1 rounded-xl border" title="CSS" />
        <Button className="px-2 mx-2 py-1 rounded-xl border" title="Vite" />
      </div>
